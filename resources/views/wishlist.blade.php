        ...
        <div class="col-sm-12 col-md-10 col-md-offset-1">
            <table class="table table-hover">
                ...
                @foreach($finalwishlist as $item)
                    <tr>
                        <td class="col-sm-8 col-md-6">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><a href="#">{{$item->image_details}}</a></h4>
                                </div>
                            </div></td>
                        ...
                        <td class="col-sm-1 col-md-1">
                            <a href="/cart/removeItem/{{$item->id}}"> <button type="button" class="btn btn-danger">
                ...
                <tr>
                    ...
                    <td>   </td>
                    <td>
                        <a href="/homeF"> <button type="button" class="btn btn-default">
                                <span class="fa fa-shopping-cart"></span> Continue Shopping
                            </button>
                        </a></td>
                    <td>
