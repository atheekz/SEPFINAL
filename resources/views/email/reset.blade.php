...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#8d8e90">
    <tr>
        <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
                ...
                <tr>
                    <td align="center"><a href= "http://yourlink" target="_blank"><img src="http://static1.squarespace.com/static/51b3dc8ee4b051b96ceb10de/t/5294d1fbe4b05f6cdadd4fb0/1385484796922/1010408_324a_1024x2000.jpg" alt="" width="598" height="323" border="0"/></a></td>
                </tr>
                <tr>
                    <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="2%">&nbsp;</td>
                                <td width="96%" align="center" style="border-bottom:1px solid #000000" height="70"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:46px; text-transform:uppercase"><strong>HI {{ $input['email'] }}</strong></font></td>
                                <td width="2%">&nbsp;</td>
                            </tr>
                        </table></td>
                </tr>
                ...
                <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="5%">&nbsp;</td>
                                <td width="90%" align="center" valign="middle"><font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:12px; line-height:20px; text-transform:uppercase">
                                        Please follow the link below to reset your password
                                        <<br/>
                                    </font><br />
                                    <font style="font-family:Verdana, Geneva, sans-serif; color:#f58220; font-size:12px; line-height:20px"><a href= {{ URL::to('freset/' ) }} style="color:#f58220; text-decoration:none"><strong>&lt; CLICK HERE TO RESET YOU PASSWORD&gt;</strong></a></font></td>
                                <td width="5%">&nbsp;</td>
                            </tr>
                        </table></td>
                </tr>
