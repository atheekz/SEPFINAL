        ...
        <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
                ...
                <tr>
                    <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="2%">&nbsp;</td>
                                <td width="96%" align="center" style="border-bottom:1px solid #000000" height="70"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:18px; text-transform:uppercase"><strong>From : {{ $input['name'] }}</strong></font></td></br></br>
                                <!--<td width="96%" align="center" style="border-bottom:1px solid #000000" height="70"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:18px;" ><strong>Email : {{ $input['email'] }}</strong></font></td></br></br>
                                <td width="96%" align="center" style="border-bottom:1px solid #000000" height="70"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:18px; "><strong>Phone Number : {{ $input['phoneNo'] }}</strong></font></td></br></br>
                                <td width="96%" align="center" style="border-bottom:1px solid #000000" height="70"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:18px; "><strong>Subject : {{ $input['subject'] }}</strong></font></td></br></br>-->
                ...
                <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="5%">&nbsp;</td>
                                <td width="90%" align="center" valign="middle"><font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:12px; line-height:20px; "><strong>Email : {{ $input['email'] }}</strong>  |||||   <strong>Phone Number : {{ $input['phoneNo'] }}</strong>  ||||| </br>  <strong>Subject : {{ $input['subject'] }}</strong>
                                         <<br/>
                                    </font><br />
                                <td width="5%">&nbsp;</td>
                            </tr>
