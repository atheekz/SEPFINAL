            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form  role="form" method="POST" action="{{ url('auth/finalregister') }}">
                            ...
                            <div id="check">
                             <a  class=""  >Select an option to get a verification code</a>
                             <select id="type" name="val_option" class="form-control">
                                 <option class="option_custom" value="email">Email</option>
                                 <option class="option_custom" value="sms">SMS</option>

                             </select>
                             <br/></div>
                             <a  class="btn btn-primary" id="check_button" >Click here to select an option to get a verification code</a>
